...
void testValues2(escenari &e) {
    /**
    * Què fa: generació hardcodejada per el test 2
    * Entrades: varibale e de tipus escenari
    * Sortides: #
    */
    e.illes[0].numIlla = 11;
    e.illes[1].numIlla = 12;
    e.illes[2].numIlla = 24;
    e.illes[3].numIlla = 33;
    e.illes[4].numIlla = 57;
    e.illes[5].numIlla = 59;
    e.illes[6].numIlla = 96;
    e.illes[7].numIlla = 97;

    e.illes[0].numEnemics = 1;
    e.illes[1].numEnemics = 4;
    e.illes[2].numEnemics = 6;
    e.illes[3].numEnemics = 4;
    e.illes[4].numEnemics = 8;
    e.illes[5].numEnemics = 9;
    e.illes[6].numEnemics = 3;
    e.illes[7].numEnemics = 5;
